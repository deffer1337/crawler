...
class TracebackEntry(object):
    ...
    def __repr__(self):
        return "<TracebackEntry %s:%d>" % (self.frame.code._path, self.lineno + 1)
...
class Traceback(list):
    ...
    def recursionindex(self):
        ...
        for i, entry in enumerate(self):
            ...
            #XXX needs a test
            key = entry.frame.code._path, id(entry.frame.code.raw), entry.lineno
...
class ExceptionInfo(object):
    ...
    def __str__(self):
        ...
        loc = ReprFileLocation(entry._path, entry.lineno + 1, self.exconly())
        return str(loc)
...
class FormattedExcinfo(object):
    ...
    def repr_traceback_entry(self, entry, excinfo=None):
        ...
        if style in ("short", "long"):
            ...
            path = self._makepath(entry._path)
